...
from model.cifar.vgg_cifar import vgg_cifar
from model.cinic.vgg_cinic import vgg_cinic
def init_bottom_model(role, args):
    ...
    # use passive hyper-parameters for passive party
        ...
        if args['backdoor'] == 'sr_ba':
            param_dict['mal_optim'] = args['mal_optim']
            param_dict['s_r_amplify_ratio'] = args['s_r_amplify_ratio']
    ...
    if args['dataset'] == 'nus_wide':
        ...
        return vgg_cifar(param_dict=param_dict)
        ...
        return vgg_cinic(param_dict=param_dict)
...
def init_top_model(args):
    ...
    if args['dataset'] == 'nus_wide':
        ...
        if args['aggregate'] == 'Concate':
            param_dict['input_dim'] = (args['n_passive_party'] + 1) * 64
        elif args['aggregate'] == 'Add':
            param_dict['input_dim'] = 64
        param_dict['output_dim'] = args['num_classes']
        param_dict['model_type'] = args['model_type']
