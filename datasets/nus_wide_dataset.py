...
from datasets.common import vfl_dataset_with_indices, train_label_split, get_random_indices, \
    get_labeled_loader, get_target_indices, poison_text_dataset
...
def load_two_party_data(data_dir, selected_labels, args):
    ...
    # get backdoor indices of the normal train dataset 154
    ...
    sr_ba_backdoor_indices_train = backdoor_indices_train
    sr_ba_backdoor_indices_train.sort()
    sr_ba_backdoor_target_indices = get_target_indices(y_train, args['backdoor_label'], len(backdoor_indices_train), sr_ba_backdoor_indices_train)
    sr_ba_backdoor_target_indices.sort()
    sr_Xb_train = poison_text_dataset(Xb_train, sr_ba_backdoor_target_indices, sr_ba_backdoor_indices_train)
    ...
    return Xa_train, Xb_train, y_train, Xa_test, Xb_test, y_test, \
           ...
           backdoor_indices_train, backdoor_target_indices, train_labeled_indices, train_unlabeled_indices, sr_Xb_train, sr_ba_backdoor_target_indices
...
def get_nus_wide_dataloader(args):
    ...
    sr_Xb_train, sr_ba_backdoor_target_indices = result
    ...
    s_r_train_dl = generate_dataloader((Xa_train, sr_Xb_train, y_train), batch_size)
