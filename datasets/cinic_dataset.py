...
def load_two_party_data(data_dir, args):
    ...
    sr_X_train, sr_ba_backdoor_indices_train = poison_image_dataset(sr_X_train, sr_y_train,
                                                                    sr_ba_backdoor_target_indices, args)
    indices_dict = None
    ...
    return X_train, y_train, X_test, y_test, backdoor_y_train, backdoor_X_test, backdoor_y_test, \
           backdoor_indices_train, backdoor_target_indices, train_labeled_indices, train_unlabeled_indices, sr_X_train, \
            sr_y_train, sr_ba_backdoor_target_indices, sr_ba_backdoor_indices_train, indices_dict, backdoor_y_test_true
...
def get_cinic_dataloader(args):
    ...
    sr_X_train, sr_y_train, sr_ba_backdoor_target_indices, sr_ba_backdoor_indices_train,\
    labeled_indices_dict, backdoor_y_test_true = result
    ...
    if args['backdoor'] == 'sr_ba':
        s_r_train_dl = generate_dataloader(args, (sr_X_train, sr_y_train), batch_size, transform,
                                       shuffle=False,backdoor_indices=sr_ba_backdoor_target_indices,
                                           trigger=args['trigger'], trigger_add=args['trigger_add'], source_indices=sr_ba_backdoor_indices_train)
